...
const SRC = '/projects/sandbox/ebook/The-Busy-Parents-Natural-Reset-Tigrinya.md';
const OUT_HTML = '/projects/sandbox/ebook/The-Busy-Parents-Natural-Reset-Tigrinya.html';
const OUT_PDF = '/projects/sandbox/ebook/The-Busy-Parents-Natural-Reset-Tigrinya.pdf';
...
// Ge'ez / Ethiopic script needs the Noto Sans Ethiopic family. Latin fallback kept for emails/numbers.
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  h1, h2, h3, h4 { font-family: "Noto Sans Ethiopic", "Noto Sans", sans-serif; color: #14532d; line-height: 1.4; }
  h1.chapter { font-size: 21pt; margin: 0 0 14px; padding-bottom: 8px; border-bottom: 3px solid #22c55e; page-break-before: always; }
  ...
  h4 { font-size: 11.5pt; margin: 12px 0 4px; color: #166534; }
  p { margin: 0 0 9px; }
  strong { color: #14532d; font-weight: 700; }
  hr { border: none; border-top: 1px solid #d1d5db; margin: 16px 0; }
  blockquote {
    margin: 14px 0; padding: 10px 16px; background: #f0fdf4;
    border-left: 4px solid #22c55e; font-style: normal; color: #374151;
    border-radius: 3px;
  }
  ...
  code { font-family: "Noto Sans", monospace; background: #f3f4f6; padding: 1px 4px; border-radius: 3px; font-size: 10.5pt; }
  table { border-collapse: collapse; width: 100%; margin: 10px 0 16px; font-size: 10.5pt; page-break-inside: avoid; }
...
<html lang="ti">
<head><meta charset="utf-8"><title>ዕረፍቲ ተፈጥሮ ንዕዉታት ወለዲ</title>
...
await page.pdf({
  ...
  footerTemplate: '<div style="width:100%; font-size:8px; color:#9ca3af; font-family:sans-serif; text-align:center;">\\u12d5\\u1228\\u134d\\u1272 \\u1270\\u1348\\u1325\\u122e \\u1295\\u12d5\\u12c8\\u1273 \\u12c8\\u1208\\u12f2 &nbsp;\\u2022&nbsp; Daniel Tesfamariam &nbsp;\\u2022&nbsp; \\u1308\\u133d <span class="pageNumber"></span> / <span class="totalPages"></span></div>',
  margin: { top: '22mm', bottom: '18mm', left: '20mm', right: '20mm' },
});
await browser.close();
console.log('Tigrinya PDF written to ' + OUT_PDF);
